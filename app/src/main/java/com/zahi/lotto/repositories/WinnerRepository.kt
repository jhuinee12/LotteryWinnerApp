...
class WinnerRepository {
    ...
    var subjectLotteryData: PublishSubject<LotteryNumber> = PublishSubject.create() // PublishSubject 객체 선언
     ...
     **/
    fun getLottoWinnerNumber(drwNo: Long) = lottoApi.getLottoWinnerNumber(drwNo = drwNo)
